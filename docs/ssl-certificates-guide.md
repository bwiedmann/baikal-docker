...
An example for Docker Compose can be found at [examples/docker-compose.ssl.yaml](https://github.com/bwiedmann/baikal-docker/blob/master/examples/docker-compose.ssl.yaml).
...
I included an example Docker Compose file [examples/docker-compose.ssl.yaml](https://github.com/bwiedmann/baikal-docker/blob/master/examples/docker-compose.ssl.yaml) as a template.
...
docker run --rm -it -p 80:80 -p 443:443 -v /etc/ssl/private/baikal:/etc/ssl/private/:ro bwiedmann/baikal:apache
```

I also included the Docker Compose template [examples/docker-compose.apache.yaml](https://github.com/bwiedmann/baikal-docker/blob/master/examples/docker-compose.apache.yaml) for this scenario.
...
docker run --rm -it -p 80:80 -p 443:443 -v /etc/ssl/private/baikal:/etc/nginx/ssl/:ro bwiedmann/baikal:nginx
```
